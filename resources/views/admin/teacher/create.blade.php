...
@section('container')
    ...
    {{-- <script>
        ...
        function tambahSkill() {
            ...
            newSkillDiv.className = 'col-md-10';
            newSkillDiv.id = 'skill' + skillCounter;

            const label = document.createElement('label');
            label.className = 'form-label';
            label.htmlFor = 'skill' + skillCounter;
            label.textContent = 'Gelar';
            ...
            // Sisipkan elemen baru ke dalam div "skill"
            newSkillDiv.appendChild(label);
            newSkillDiv.appendChild(input);
            document.getElementById('skill').appendChild(newSkillDiv);
        }
    </script> --}}
@endsection
